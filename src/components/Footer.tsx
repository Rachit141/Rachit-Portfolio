      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <a href="mailto:rachitjain5265@gmail.com" className="text-sm hover:text-indigo-400 transition-colors">
                  rachitjain5265@gmail.com
                </a>
              </li>
              <li className="flex items-center">
                <Phone className="w-4 h-4 mr-2 text-cyan-200" />
                <a href="tel:+918218813748" className="text-sm hover:text-indigo-400 00 transition-colors">
                  +91 82188 13748
                </a>
              </li>
            </ul>
            ...
            <div className="flex space-x-3 pt-2">
              <motion.a 
                href="https://github.com/Rachit141/" 
                target="_blank" 
              ...
              <motion.a 
                href="https://www.linkedin.com/in/rachit-jain14/" 
                target="_blank" 
                rel="noopener noreferrer"
                whileHover={{ scale: 1.1 }}
                className="bg-white/10 p-2 rounded-full hover:bg-white/20 transition-colors"
        ...
        <div className="border-t border-white/10 mt-6 pt-4 text-center">
          <p className="text-xs text-white/70">
            © {new Date().getFullYear()} Rachit Jain. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
