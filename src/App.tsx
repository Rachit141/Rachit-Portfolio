  ...
  return (
    <div className="font-inter text-gray-800 dark:text-gray-200 bg-white dark:bg-dark min-h-screen">
      ...
      <div className="fixed left-4 top-1/2 -translate-y-1/2 space-y-4 z-50">
        <SocialButton href="https://github.com/Rachit141/" icon={<Github />} label="GitHub" />
        <SocialButton href="https://www.linkedin.com/in/rachit-jain14/" icon={<Linkedin />} label="LinkedIn" />
      </div>
